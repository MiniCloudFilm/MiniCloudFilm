    ...
    wx.request({
      ...
      success: res => {
        ...
        if (res.statusCode == "200") {
          wx.redirectTo({
            url: `../ConInterface/ConInterface?dialogId=${data.dialogId}&reportId=${payList.reportId}&dialoger=${payList.doctorName}&consultId=${data.concultId}&fromWhere=noRecord`
          })
        }
      }
    })
